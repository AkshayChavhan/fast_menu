...
FUNCTIONS=(import_menu is_platform_admin normalize_hotel_name claim_trial enforce_trial_before_publish list_trial_reviews review_trial set_dish_modifiers)
TESTS=(import_menu.test.sql claim_trial.test.sql set_dish_modifiers.test.sql)
